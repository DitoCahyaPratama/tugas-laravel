        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3 mt-3" action="{{route('register')}}" method="POST">
                @csrf
                <div class="mb-3">
                  ...
                  <input
                    ...
                    class="form-control"
                    id="name"
                    required="" name="name" placeholder="Your Name" :value="old('name')" required autofocus autocomplete="name"
                  />
                ...
                <div class="mb-3">
                  ...
                  <input
                    ...
                    class="form-control"
                    id="email"
                    required="" name="email" placeholder="Email Kamu" :value="old('email') required autofocus"
                  />
